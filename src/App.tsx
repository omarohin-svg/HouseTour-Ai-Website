      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-white/80 border-b border-gray-200/80 transition-all">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center space-x-2.5 group">
            <div className="w-9 h-9 rounded-xl bg-[#0071e3] flex items-center justify-center text-white shadow-sm group-hover:scale-105 transition-transform">
              <CameraIcon className="w-5 h-5" />
            </div>
            <span className="font-extrabold text-xl tracking-tight text-[#1d1d1f]">
              HouseTour <span className="text-[#0071e3]">AI</span>
            </span>
          </a>
